...
- **사용량 상세** — 팝오버에서 두 영역의 원을 크게 보고 사용률·기록된 달러 비용·둘 다 중 표시 형식을 Display 설정에서 선택합니다. 추정 한도는 기본적으로 꺼져 있으며, 일치하는 사용률과 비용 데이터가 뒷받침할 때만 표시됩니다. 보장된 청구 한도가 아닌 비공식 추정치입니다. 원과 알림은 항상 서버 사용률을 사용하며, 추가 지출과 Bot 활동은 별도로 표시합니다.
